package com.wsep202.TradingSystem.web.controllers.api;

public class PublicApiPaths {

    public static final String CLIENT_DESTINATIONS_PREFIXED = "/trading-system-client";
    ...
    public static final String BUYER_REGISTERED_PATH = "/buyer-registered";
