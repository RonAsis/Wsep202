...
//////////////////////////////////////////////////////////////////////////////////////////////Integration/////////////////////////////////////////////////////////////////////////////
    ...
    public class ComposedPurchaseTestIntegration {
        ...
        void setUp() {
            ...
            purchase2 = new Purchase(productDetailsPolicy1, PurchaseType.PRODUCT_DETAILS,"test 1 product policy");
            purchase3 = new Purchase(productDetailsPolicy2, PurchaseType.PRODUCT_DETAILS, "test 2 product policy");
            purchase4 = new Purchase(userDetailsPolicy, PurchaseType.USER_DETAILS, "test 1 user policy");
            composedPurchasePolicies = new LinkedList<>();
            composedPurchasePolicies.add(purchase2);
            composedPurchasePolicies.add(purchase3);
            composedPurchasePolicies.add(purchase4);
            composedPurchase = new ComposedPurchase(CompositeOperator.AND,composedPurchasePolicies);
            purchase1 = new Purchase(composedPurchase, PurchaseType.COMPOSED_POLICY,"test composed policy");
        }
